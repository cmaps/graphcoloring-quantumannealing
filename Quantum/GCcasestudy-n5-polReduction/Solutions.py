...
if __name__ == "__main__":
    ...
    df.columns = [r'$\alpha$=0' '\n' r'$\beta$=130', r'$\alpha$=1' '\n' r'$\beta$=255', r'$\alpha$=2' '\n' r'$\beta$=380', r'$\alpha$=3' '\n' r'$\beta$=505', r'$\alpha$=4' '\n' r'$\beta$=630', r'$\alpha$=5' '\n' r'$\beta$=755']
    ax=df.plot(kind='bar',  colormap='Set3', stacked=False)
    ax.set(ylabel='Variation of possible solutions')
    ax.set_xticklabels(df.columns, rotation=360)
    ax.legend(title='Q(ms)',bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
    plt.savefig('groupedbar_ms.pdf', bbox_inches='tight')
